...
<jsp:include page="includes/head.jsp">
	<jsp:param value="FACTURAS EMITIDAS" name="titulo" />
</jsp:include>
			...
			<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-lg-12">
							...
							<div class="col-lg-6">
								<label for="deCuentaCli"> De cuenta cli:</label><input type="text" name="deCuentaCli" value="deCuentaCli" id="deCuentaCli"><br>
								<label for="aCuentaCli"> A cuenta cli:</label><input type="text" name="aCuentaCli" value="aCuentaCli" id="aCuentaCli">
							</div>
						</div>
					</div>
			</div>
